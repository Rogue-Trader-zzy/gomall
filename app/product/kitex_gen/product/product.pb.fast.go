...
func (x *ListProductsReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.CategorynName, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *ListProductsReq) fastWriteField3(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 3, x.GetCategorynName())
	return offset
}
...
func (x *ListProductsReq) sizeField3() (n int) {
	...
	n += fastpb.SizeString(3, x.GetCategorynName())
	return n
}
