...
import (
	...
	checkout "github.com/Rogue-Trader-zzy/gomall/rpc_gen/kitex_gen/checkout"
	email "github.com/Rogue-Trader-zzy/gomall/rpc_gen/kitex_gen/email"
	"github.com/Rogue-Trader-zzy/gomall/rpc_gen/kitex_gen/order"
	"github.com/Rogue-Trader-zzy/gomall/rpc_gen/kitex_gen/payment"
...
func (s *CheckoutService) Run(req *checkout.CheckoutReq) (resp *checkout.CheckoutResp, err error) {
	...
	if err != nil {
		return nil, kerrors.NewGRPCBizStatusError(5004003, "invalid zip code")
	}
	...
	data, _ := proto.Marshal(&email.EmailReq{
		...
		Subject:     "You hava just created an order in the CloudweGo Shop",
		Content:     "You hava just created an order in the CloudweGo Shop",
	})
